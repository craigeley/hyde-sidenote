(function() {
    ...
    (function(e, i, o) {
        ...
        e.fn.extend({
            sidenotes: function() {
                var i, o;
                o = arguments[0], i = 2 <= arguments.length ? t.call(arguments, 1) : [];
                return this.each(function() {
                    var t, s, n;
                    t = e(this);
                    s = (n = t.data("sidenotes")) != null ? n : t.data("sidenotes", new r(this, o));
                    if (typeof o === "string") {
                        s[o].apply(s, i);
                        if (o === "destroy") {
                            t.removeData("sidenotes")
                        }
                    }
                    return true
                })
        ...
        r = function() {
            ...
            function t(t, i) {
                ...
                if (this.options.hideFootnoteContainer) {
                    this.$footnoteContainer = e(this.options.footnoteContainerSelector, t)
                }
                ...
                this.$footnotes = e(this.options.footnoteContainerSelector + " " + this.options.footnoteSelector, this.$postContainer);
                ...
                this.$footnotes.each(function() {
                    ...
                    t = this;
                    e = t.id;
                    h = o.options.removeRefMarkRegex.test(e);
                    a = new s(t, h ? null : r++, o);
                    o.sidenotes.push(a);
                    f = (d = o.sidenotes[o.sidenotes.length - 2]) != null ? d : null;
                    if (f != null ? f.$pivot.is(a.$pivot) : void 0) {
                        if (f.hasGroup()) {
                            return f.group.push(a)
                        } else {
                            i = new n([f, a], o);
                            return o.groups.push(i)
                        }
                    }
                });
            ...
            t.prototype.show = function(t) {
                ...
                if (this.isHidden || t) {
                    ...
                    for (o = 0, n = h.length; o < n; o++) {
                        i = h[o];
                        if (t && !i.hasGroup()) {
                            i.$pivot[this.sidenotePlacement()](i.$sidenote)
                        }
                        i.show()
                    }
                    f = this.groups;
                    for (s = 0, r = f.length; s < r; s++) {
                        e = f[s];
                        if (t) {
                            e.$pivot[this.sidenotePlacement()](e.$group)
                        }
                        e.show()
                    }
            ...
            t.prototype.sidenotePlacement = function(t, e) {
                var i, o, s, n, r, h, f, a;
                if ((t === "before" || t === "after") && (t !== this.sidenotePlacement() || e)) {
                    f = this.sidenotes;
                    for (s = 0, r = f.length; s < r; s++) {
                        o = f[s];
                        if (!o.hasGroup()) {
                            o.$pivot[t](o.$sidenote)
                        }
                    }
                    a = this.groups;
                    ...
                    return this.sidenotesAfterRef = t === "after"
                } else {
        ...
        s = function() {
            function t(t, i, o) {
                ...
                this.$footnote = e(t);
                this.owner = o;
                this.footnoteID = t.id;
                this.sidenoteID = this.owner.options.formatSidenoteID(this.footnoteID);
                this.ref = i > 0 ? i : null;
                this.$refMarkAnchor = e("a[href='#" + h(this.footnoteID) + "']", this.owner.$postContainer);
                this.$refMarkSup = this.$refMarkAnchor.parent("sup");
                this.$refMarkSup = this.$refMarkSup.size() !== 0 ? this.$refMarkSup : null;
                this.isNested = e.contains(this.owner.$footnoteContainer.get(0), this.refMark().get(0));
                if (this.isNested) {
                    n = this.refMark().closest(this.owner.$footnotes);
                    d = this.owner.sidenotes;
                ...
                this.group = null;
                s = e("a[href='#" + h(this.refMarkID) + "']", this.$sidenote);
                if (s != null && this.noMark()) {
                    this.owner.options.hide(s)
                }
                this.owner.options.hide(this.$sidenote);
                this.isHidden = true
            }
            t.prototype.noMark = function() {
            ...
            t.prototype.refMark = function() {
                var t;
                return (t = this.$refMarkSup) != null ? t : this.$refMarkAnchor
            };
            return t
        }();
        n = function() {
            function t(t, i) {
                ...
                this.sidenotes = [];
                this.owner = i;
                this.$group = e("<" + this.owner.options.sidenoteGroupElement + "/>", {
                    "class": this.owner.options.sidenoteGroupClass
                });
                this.push(t);
                this.$pivot = (o = this.sidenotes[0]) != null ? o.$pivot : void 0;
                this.owner.options.hide(this.$group);
                this.isHidden = true
            }
            t.prototype.push = function(t) {
                var e, i, o, s, n;
                i = t instanceof Array ? t : [t];
                (n = this.sidenotes).push.apply(n, i);
                for (o = 0, s = i.length; o < s; o++) {
                    e = i[o];
                    this.$group.append(e.$sidenote);
                    e.group = this
                }
